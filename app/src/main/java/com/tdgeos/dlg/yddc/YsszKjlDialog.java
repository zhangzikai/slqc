...
public class YsszKjlDialog extends Dialog implements View.OnClickListener {
    ...
    public YsszKjlDialog(Context context, int ydh, int xh) {
        super(context);
    ...
    private void loadList() {
        ...
        List<String> lstSz = YangdiMgr.GetKjlShuzhong(ydh, xh);
        System.out.println("count = " + lstSz.size());
        ...
        for (int i = 0; i < lstSz.size(); i++) {
            ...
            int count = YangdiMgr.GetKjlZhushu(ydh, xh, code);
            float pjxj = YangdiMgr.GetKjlPjxj(ydh, xh, code);
            float dmj = YangdiMgr.GetKjlDmj(ydh, xh, code);
            zmj += dmj;
            ...
            item.dmj = dmj;
            lst.add(item);
            System.out.println("item = " + count + "; " + pjxj + "; " + dmj);
        }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_ok: {
                ...
                YangdiMgr.SetKjlYssz(ydh, xh, dm, szs);

                result = new String[2];
                result[0] = String.valueOf(dm);
                result[1] = szs;
